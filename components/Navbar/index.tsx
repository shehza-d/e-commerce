...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-0 mt-3 bg-red-500 w-full">
      ...
      <div className="bdr3 bg-white px-4 md:px-8 nav-bar z-30 rounded-sm w-full backdrop-blur-3xl">
        <div className="bdr4 m-auto flex  h-16 items-center rounded-sm justify-between">
